    Программа предназначена для преобразования банковской выписки 
    интернет-банкинга Белагропромбанка в формате CSV
    В SQL скрипт, заносящий новые данные в базу данных.
    Также программа определяет Id плательщика в базе данных из имени в выписке.
    ...
    После тестирования, для работы программы, достаточно файла выписки.
